...
Abigail Oppong, Hellina Nigatu, and **Chinasa T. Okolo**. "Evaluating Gender Bias for Low-Resource African Languages in LLMs." In the [_Workshop on Gender Bias for Natural Language Processing_](https://gebnlp-workshop.github.io/) at the Annual Meeting of the Association for Computational Linguistics (ACL), 2025.
